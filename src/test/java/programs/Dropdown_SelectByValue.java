...
public class Dropdown_SelectByValue {
	...
	public static void main(String[] args) {
		System.out.println("Program to select dropdown value by value...");
...
// Output:
// Program to select dropdown value by value...
// Option selected: 'Saab'
// Text displayed: 'cars=saab'. Test Passed.