...
public class MouseAction_DoubleClick_WithoutPassingElement {

	public static void main(String[] args) {
		System.out.println("Performing double click on an element (passing element)...");
...
// Output:
// Performing double click on an element (passing element)...
