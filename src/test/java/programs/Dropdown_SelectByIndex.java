...
public class Dropdown_SelectByIndex {
	...
	public static void main(String[] args) {
		System.out.println("Program to select dropdown value by index");
		...
		try {
			...
			String expectedText = "cars=volvo";
...
// Output:
// Program to select dropdown value by index
// Option selected: 'Volvo'
// Text displayed: 'cars=volvo'. Test Passed.
